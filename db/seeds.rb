...
user.build_listing({
  ...
  phone: '7146127367', 
  portfolio_photo_description: "Here is an example of some of our fine fine work. As you can see, we only do the finest work. For more information feel free to contact us via email or phone.  Whichever works best for you!",
