$(function() {
  ...
  $('#user_listing_attributes_portfolio_photos_attributes_0_portfolio_photo').bind('change', function(e) { 
    var file = $(this),
  ...
  $('#user_listing_attributes_portfolio_photos_attributes_0_description').on('blur keyup', function() {
